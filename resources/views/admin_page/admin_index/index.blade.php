        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('editSliders')}}"><i class="fa fa-camera-retro fa-fw"></i> Slides</a>
                    </li>
                    <li>
                        <a href="{{route('front_page_content')}}"><i class="fa fa-desktop fa-fw"></i> Front page content</a>
                    </li>
                    <li>
